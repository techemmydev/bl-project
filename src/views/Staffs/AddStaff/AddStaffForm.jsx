...
import style from "../../Staffs/AddStaff/Addstaff.module.css";
import "@fortawesome/fontawesome-free/css/all.min.css";
import UserIconWithAdd from "../Components/UserIconWithAdd";
...
const fields = [
  ...
  },
  {
    ...
    label: "Staff ID",
    type: "text",
    placeholder: "Enter Staff I.D",
  },
  {
    id: "city",
    label: "City",
    type: "select",
    options: ["Enter City", "State 1", "State 2"],
  },
  {
    id: "state",
    label: "State",
    type: "select",
    options: ["Select State", "State 1", "State 2"],
  },
  {
    id: "degreeProgram",
    label: "Degree Program",
    type: "select",
    options: ["Enter degree program", "degree 1", "degree  2"],
  },
  {
    id: "institution",
    label: "Institution",
    type: "select",
    options: ["Enter Institution", "Institution 1", "Institution 2"],
  },
  { id: "position", label: "Position/Designation", type: "text" },
  {
    id: "company",
    label: "Company",
    type: "text",
  ...
  },
  {
    ...
    label: "Job Type",
    type: "select",
    options: ["Enter degree program", "program 1", "program 2"],
  },
