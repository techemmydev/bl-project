...
import style from "../../../component/AllAccountCard/AccountAjoCard/ajoformstyle.module.css";
import UserStatus from "../../UserStatus/UserStatus";
import { GlobalContext } from "../../../UseContext/ContextProvider";
const AjoTransactionForm = ({ types, onSubmit }) => {
      ...
      <div className={`card ${style.card_inner}`}>
        <div className={` card-body`}>
          <div className="text-center mb-4">
            ...
            <p className="mt-3">Ajo</p>
          </div>

          <h4 className="text-center">{types.toUpperCase()}</h4>
          ...
          <form onSubmit={onSubmit} className={` ${style.form_Inputdiv}`}>
            ...
            <div className="d-flex justify-content-between gap-5 mt-5">
              ...
              >
                {types === "DEPOSIT" ? "Deposit" : "Withdrawal"}
              </button>
            </div>
          </form>
        </div>
...
export default AjoTransactionForm;
